...
def _import_worker(module_dotted: str, file_path: Path):
    ...
    module is cached in sys.modules during this import, it stays cached — a
    later bare import inside that worker's own route handler hits the
    sys.modules cache directly and never needs to fall back to sys.path.
    """
