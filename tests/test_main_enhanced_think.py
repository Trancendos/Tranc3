"""TRANC3Enhanced.think and .encode — reasoning paths and error handling.

Split out of tests/test_main_enhanced.py for the same reason as
tests/test_main_enhanced_initialize.py: disjoint tests, one shared filename.
"""
