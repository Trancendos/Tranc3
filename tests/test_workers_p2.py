...
def _import_worker(module_dotted: str, file_path: Path):
    ...
    import so shim-style workers (e.g. the-grid's worker.py -> main.py) can
    resolve their bare sibling imports, matching how the Dockerfile COPYs
    them flat into the container's WORKDIR.
