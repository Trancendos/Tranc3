...
class TestPathValidation:
    """Tests for Dimensionals.path_validation module."""
    ...
    def test_validate_path_traversal_blocked(self):
        from Dimensionals.path_validation import PathTraversalError, validate_path
    ...
    def test_safe_join_normal(self):
        from Dimensionals.path_validation import safe_join
    ...
    def test_sanitize_filename_normal(self):
        from Dimensionals.path_validation import sanitize_filename
...
class TestErrorHandlers:
    ...
    def test_safe_error_detail_development(self):
        ...
        with patch("Dimensionals.error_handlers._IS_PROD", False):
...
class TestLogSanitization:
    """Tests for Dimensionals.sanitize module."""
    ...
    def test_sanitize_dict_for_log_redaction(self):
        from Dimensionals.sanitize import sanitize_dict_for_log
