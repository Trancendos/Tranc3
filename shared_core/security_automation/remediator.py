"""
shared_core.security_automation.remediator — Automated security remediation engine.
...
class AutoRemediator:
    ...
    def _fix_log_injection(self, content: str, violations: List[Violation], filepath: str) -> str:
        ...
        lines = content.split("\n")
        modified = False
        has_sanitize_import = "from shared_core.sanitize import sanitize_for_log" in content
