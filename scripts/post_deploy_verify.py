...
ALL_ENTITIES: list[dict] = [
    ...
    {"name": "the-studio", "port": 8069, "tier": "planned", "path": "/health"},
    {"name": "sashas-photo-studio", "port": 8062, "tier": "planned", "path": "/health"},
    {"name": "tranceflow", "port": 8059, "tier": "planned", "path": "/health"},
    {"name": "tateking", "port": 8061, "tier": "planned", "path": "/health"},
    {"name": "imaginarium", "port": 8064, "tier": "planned", "path": "/health"},
    {"name": "the-lab", "port": 8055, "tier": "planned", "path": "/health"},
    {"name": "warp-tunnel", "port": 8072, "tier": "planned", "path": "/health"},
    {"name": "warp-radio", "port": 8073, "tier": "planned", "path": "/health"},
    {"name": "the-dutchy", "port": 8057, "tier": "planned", "path": "/health"},
    {"name": "devocity", "port": 8110, "tier": "planned", "path": "/health"},
    {"name": "tranquility", "port": 8077, "tier": "planned", "path": "/health"},
    {"name": "imind", "port": 8075, "tier": "planned", "path": "/health"},
    {"name": "taimra", "port": 8074, "tier": "planned", "path": "/health"},
    {"name": "vrar3d", "port": 8060, "tier": "planned", "path": "/health"},
    {"name": "resonate", "port": 8076, "tier": "planned", "path": "/health"},
    {"name": "chaos-party", "port": 8079, "tier": "planned", "path": "/health"},
]
