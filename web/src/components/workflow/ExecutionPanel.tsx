        ...
        <div className="flex-1 overflow-y-auto p-3 space-y-3">
          ...
          {(status.status === "running" || status.status === "pending") && (
            <button
              ...
              className="w-full py-1.5 text-xs font-medium bg-red-900/50 hover:bg-red-900 text-red-300 rounded transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-1 focus-visible:ring-offset-gray-900"
            >
              Cancel Execution
            </button>
          )}
