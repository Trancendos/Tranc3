    ...
    <div className="fixed inset-y-0 right-0 w-[420px] bg-gray-950 border-l border-gray-800 shadow-2xl z-50 flex flex-col overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-800" style={{ background: `linear-gradient(135deg, ${pillarColor}15, transparent)` }}>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onClose} aria-label="Close details" className="p-2 rounded-lg hover:bg-gray-800 text-gray-500 hover:text-white transition-colors">
            ✕
          </button>
        </div>
        ...
        <div className="flex-1 flex flex-col items-center py-3 gap-2">
          ...
          {pillars.map(pillar => (
            <button key={pillar.id} onClick={() => onSelectPillar(pillar.id)}
                    ...
                    title={pillar.name}>
              <div className="w-3 h-3 rounded-full" aria-hidden="true" style={{ backgroundColor: pillar.color }} />
            </button>
          ))}
        </div>
      )}
    ...
    <div className="flex items-center justify-between px-6 h-14 border-b border-gray-800 bg-gray-950/80 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button aria-label={`Alerts, ${totalAlerts} unread`} className="p-2 rounded-lg hover:bg-gray-800 text-gray-500 hover:text-white transition-colors relative">
