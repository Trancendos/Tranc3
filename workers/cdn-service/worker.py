"""
Trancendos cdn-service — Self-Hosted Worker (STUB)
===================================================
CDN origin API
...
app = FastAPI(
    title="cdn-service",
    description="CDN origin API (Stub — TODO: Full implementation)",
    version="0.1.0",
)
...
# TODO: Implement domain-specific endpoints for cdn-service
