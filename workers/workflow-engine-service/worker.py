...
async def _lifespan(app: FastAPI):
    ...
    try:
        ...
        instrument_worker(app, service_name="tranc3.workflow-engine-service")
    except Exception:
...
@app.get("/health")
async def health():
    return {"status": "ok", "service": "workflow-engine-service", "port": 8034}
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=8034)  # nosec B104 — containerised service
