"""
Trancendos geo-service — Self-Hosted Worker (STUB)
===================================================
Geolocation API
...
app = FastAPI(
    title="geo-service",
    description="Geolocation API (Stub — TODO: Full implementation)",
    version="0.1.0",
)
...
# TODO: Implement domain-specific endpoints for geo-service
