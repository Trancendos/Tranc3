...
from Dimensionals.cors import resolve_cors_origins
from Dimensionals.infinity.abac import ABACEngine
...
def create_nexus_app() -> FastAPI:
    ...
    async def cluster_status():
        ...
        from Dimensionals.nexus.raft.raft_core import get_nexus_cluster
    ...
    async def pillar_locations():
        ...
        from Dimensionals.pillars.entities import get_pillar_registry
    ...
    async def pillar_tiers():
        ...
        from Dimensionals.pillars.entities import EntityTier, get_pillar_registry
