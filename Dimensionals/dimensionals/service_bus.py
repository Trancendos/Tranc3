...
Usage:
    from Dimensionals.dimensionals.service_bus import DimensionalServiceBus, get_dimensional_bus
...
from Dimensionals.dimensionals.registry import (
    DimensionalServiceRegistry,
    get_dimensional_registry,
)
from Dimensionals.infinity.nomenclature import Pillar, Tier
...
try:
    from Dimensionals.architecture.fluidic_router import FluidicRouter
...
try:
    from Dimensionals.architecture.causal_event_bus import CausalEventBus
...
class DimensionalServiceBus:
    ...
    Ecosystem's Dimensional (Dimensional's) layer. It integrates with
