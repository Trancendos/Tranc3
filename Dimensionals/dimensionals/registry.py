...
=========================================
Central registry for Dimensional's — the Dimensional services that form
...
class DimensionalService:
    ...
    Dimensional's are the Dimensional services that provide fundamental
    ...
    def __post_init__(self) -> None:
        ...
        if self.prime_id is None:
            from Dimensionals.infinity.nomenclature import PILLAR_PRIME_MAP
...
class DimensionalServiceRegistry:
    ...
    Dimensionals.registry, providing an additional layer of pillar
