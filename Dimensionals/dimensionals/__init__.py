...
Usage:
    from Dimensionals.dimensionals import DimensionalServiceRegistry, get_dimensional_registry
...
from Dimensionals.dimensionals.service_bus import (
    DimensionalServiceBus,
    get_dimensional_bus,
)
from Dimensionals.dimensionals.underverse import (
    UnderverseModule,
    UnderverseRegistry,
