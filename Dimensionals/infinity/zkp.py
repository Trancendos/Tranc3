"""
Dimensionals.infinity.zkp — Zero Knowledge Proof Authentication Module
======================================================================
...
-----
    import os
    from Dimensionals.infinity.zkp import ZKPProver, ZKPVerifier, ZKPRegistry
    ...
    tier_secret = os.environ["TIER_AI_SECRET"]
    tier_proof = prover.prove_tier_membership(tier=Tier.AI, shared_secret=tier_secret)
