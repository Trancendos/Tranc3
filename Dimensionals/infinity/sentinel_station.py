...
Usage:
    from Dimensionals.infinity.sentinel_station import SentinelStation
...
from Dimensionals.infinity.sentinel_config import (
    FallbackConfig,
    RedisConfig,
...
# Dimensionals/circuit_state.py. It was previously defined here as a (str, Enum)
# with identical members and values — one of three such copies inside
# Dimensionals/, and of eight across the platform.
