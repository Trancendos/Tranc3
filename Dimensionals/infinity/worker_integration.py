"""
Dimensionals.infinity.worker_integration — Smart Worker Integration Helpers
===========================================================================
...
try:
    from Dimensionals.infinity.adaptive_intelligence import (  # noqa: F401
...
def _make_sentinel_fn(sentinel: Any) -> Callable:
    ...
    async def _publish(channel: str, event_type: str, payload: dict) -> None:
        try:
            from Dimensionals.infinity.sentinel_station import SentinelChannel, SentinelEvent
