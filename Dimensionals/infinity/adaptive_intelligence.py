"""
Dimensionals.infinity.adaptive_intelligence — Unified Smart Adaptive Intelligence Layer
========================================================================================
...
Usage in any Infinity worker:
    from Dimensionals.infinity.adaptive_intelligence import InfinityHealthOrchestrator
...
try:
    from Dimensionals.architecture.adaptive_pulse import AdaptivePulseController, PulseMode
...
try:
    from Dimensionals.middleware.telemetry import TelemetryCollector, TelemetryMiddleware
