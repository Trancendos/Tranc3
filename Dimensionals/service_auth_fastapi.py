...
`Dimensionals.service_auth` deliberately imports no web framework: it deals in
...
`Dimensionals.service_auth` directly and translates the error itself.
...
from Dimensionals.service_auth import ServiceAuthError, verify_internal_secret
