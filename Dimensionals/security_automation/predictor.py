"""
Dimensionals.security_automation.predictor — Violation predictor for proactive security.
...
class SafePatternDetector:
    ...
    SAFE_PATTERNS = [
        ...
        (r"from Dimensionals\.path_validation import", -0.2, "CWE-022"),
        (r"from Dimensionals\.error_handlers import", -0.2, "CWE-209"),
        (r"from Dimensionals\.sanitize import", -0.2, "CWE-117"),
    ]
