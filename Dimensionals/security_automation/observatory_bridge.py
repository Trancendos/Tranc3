...
WHY IT LIVES IN Dimensionals/ AND NOT src/
...
from Dimensionals.security_automation.adaptive_scanner import AdaptiveViolation, Confidence
from Dimensionals.security_automation.scanner import Severity

if TYPE_CHECKING:  # pragma: no cover — typing only, never imported at runtime
    from Dimensionals.security_automation.watchdog import ScanAlert
