"""
Dimensionals.security_automation.__main__ — CLI entry point.
...
Usage:
    ...
    python -m Dimensionals.security_automation scan --severity high src/

    # Auto-fix violations (dry run):
    python -m Dimensionals.security_automation fix --dry-run src/
    ...
    python -m Dimensionals.security_automation gate src/
...
from Dimensionals.security_automation.scanner import Category, SecurityScanner, Severity, Violation
from Dimensionals.security_automation.telemetry import (
    QualityGate,
    ScanResult,
    SecurityTelemetry,
)
