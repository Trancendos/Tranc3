"""
Dimensionals.security_automation.watchdog — Real-time file watcher with proactive security scanning.
...
Usage:
    from Dimensionals.security_automation.watchdog import SecurityWatchdog

    watchdog = SecurityWatchdog(
        watch_paths=["src/", "Dimensionals/"],
...
from Dimensionals.security_automation.adaptive_scanner import AdaptiveScanner, AdaptiveViolation
from Dimensionals.security_automation.scanner import Severity
