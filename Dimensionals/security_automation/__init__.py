"""
Dimensionals.security_automation — Proactive Security Automation Framework.
...
Usage:
    ...
    python -m Dimensionals.security_automation scan src/

    # Auto-fix violations:
    python -m Dimensionals.security_automation fix src/

    # Generate compliance report:
    python -m Dimensionals.security_automation report src/

    # Run as a long-lived watcher (for CI):
    python -m Dimensionals.security_automation watch src/
    ...
    from Dimensionals.security_automation.predictor import ViolationPredictor
    predictor = ViolationPredictor()
    predictions = predictor.predict("src/")
"""

from Dimensionals.security_automation.adaptive_scanner import (
    AdaptiveScanner,
    AdaptiveViolation,
    Confidence,
)
from Dimensionals.security_automation.predictor import Prediction, ViolationPredictor
from Dimensionals.security_automation.remediator import AutoRemediator
from Dimensionals.security_automation.remediator_v2 import (
    AutoRemediatorV2,
    FixResult,
    RemediationSession,
)
from Dimensionals.security_automation.scanner import SecurityScanner, Violation
from Dimensionals.security_automation.telemetry import SecurityTelemetry
from Dimensionals.security_automation.watchdog import ScanAlert, SecurityWatchdog
