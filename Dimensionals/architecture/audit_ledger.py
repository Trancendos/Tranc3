"""
Dimensionals.architecture.audit_ledger — Append-only signed records for compliance.
...
Usage:
    from Dimensionals.architecture.audit_ledger import AuditLedger, AuditRecord
