# Dimensionals/architecture/oci_storage.py — Oracle Cloud Infrastructure Object Storage Provider
...
from Dimensionals.architecture.storage_factory import StorageProvider, SystemMode
