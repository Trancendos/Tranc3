...
# `import Dimensionals` pull 1342 modules, among them torch, numpy, cuda, ncps
...
#
#     from Dimensionals.service_auth import verify_internal_secret
#
...
# `from Dimensionals import EventBus` still works, and still returns the same
...
# `from Dimensionals import *`; adding the submodules here would make that star
