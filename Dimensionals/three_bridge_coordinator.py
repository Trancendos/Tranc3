...
from Dimensionals.hive.sentinel_bridge import (
    HiveSentinelBridge,
)
from Dimensionals.hive.sentinel_bridge import (
...
from Dimensionals.nexus.sentinel_bridge import (
    NexusSentinelBridge,
)
from Dimensionals.nexus.sentinel_bridge import (
...
class ThreeBridgeCoordinator:
    ...
    def sentinel_station(self):
        if self._sentinel_station is None:
            try:
                from Dimensionals.infinity.sentinel_station import get_sentinel_station
