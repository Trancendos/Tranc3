...
PLATFORM_ENTITIES: Dict[str, LocationEntity] = {
    ...
    "The HIVE": LocationEntity(
        ...
        bot_01=Bot("Worker-Bee", "Carries small payload updates between nodes."),
        bot_02=Bot("Drone-7", "Sweeps transport lanes to prune stuck packets."),
        bot_03=Bot("Nectar-Fetch", "Pulls system-state configuration updates."),
        bot_04=Bot("Comb-Builder", "Creates dynamic memory blocks for spikes."),
        worker_port=8022,
    ...
    "Arcadia": LocationEntity(
        ...
        bot_01=Bot("Mail-Sorter", "Categorizes and dispatches inbound emails."),
        bot_02=Bot("Thread-Pumper", "Injects live forum updates into the UI."),
        bot_03=Bot("UI-Renderer", "Translates local templates into responsive UI."),
        bot_04=Bot("Cache-Fetch", "Grabs local media/templates to speed up loads."),
        worker_port=None,
        worker_path="web/",
    ),
    ...
    "Luminous": LocationEntity(
        ...
        agent_alpha=Agent("Synapse", "Monitors global activity; triggers alerts for offline nodes."),
        agent_beta=Agent("Cortex", "Translates objectives into workflow blueprints."),
        bot_01=Bot("Neuron-1", "Listens for emergency signals for immediate attention."),
        bot_02=Bot("Neuron-2", "Holds transient conversational state metrics."),
        bot_03=Bot("Dendrite", "Collects performance metrics from peripheral nodes."),
        bot_04=Bot("Axon", "Transmits executive commands to Agents/Bots."),
        worker_port=8009,
    ...
    "The Town Hall": LocationEntity(
        ...
        bot_01=Bot("Gavel", "Halts operations in sandboxes for security violations."),
        bot_02=Bot("Scroll", "Writes unalterable logs of compliance actions."),
        bot_03=Bot("Red-Tape", "Auto-generates compliance paperwork and checklists."),
        bot_04=Bot("Stamp", "Signs certificates for approved system tools."),
        worker_port=None,
    ...
    "The Studio": LocationEntity(
        ...
        bot_01=Bot("Palette", "Translates color variables into matching stylesheets."),
        bot_02=Bot("Easel", "Renders dynamic design drafts for live preview."),
        bot_03=Bot("Clay", "Speeds up simple vector and morphing operations."),
    ...
    "Sashas Photo Studio": LocationEntity(
        ...
        bot_01=Bot("Aperture", "Adjusts focus matrices, blur, and depth of field."),
        bot_02=Bot("Shutter", "Triggers high-speed renders to output flat image layers."),
        bot_03=Bot("Flash", "Regulates light direction, balance, and HDR variables."),
        bot_04=Bot("Lens", "Fixes perspective distortions and lens anomalies."),
        worker_port=None,
        worker_path="src/studio/",
    ),
    ...
    "TranceFlow": LocationEntity(
        ...
        bot_01=Bot("Voxel-1", "Generates grid-based blocks and terrain geometries."),
        bot_02=Bot("Collider", "Monitors boundary boxes for collision scripts."),
        bot_03=Bot("Ray-Tracer", "Handles lighting paths, reflections, and shadows."),
        bot_04=Bot("Sprite", "Renders fast 2D graphics and UIs over 3D spaces."),
        worker_port=None,
        worker_path="src/studio/",
    ),
    ...
    "TateKing": LocationEntity(
        ...
        agent_alpha=Agent("The Director", "Coordinates timeline-as-code scripting from video data."),
        agent_beta=Agent("The Editor", "Suggests cuts, music shifts, and scene transitions."),
        bot_01=Bot("Cutter", "Slices video and audio tracks at precise timestamps."),
        bot_02=Bot("Splicer", "Joins video clips and audio tracks into unified tracks."),
        bot_03=Bot("Renderer", "Compresses/outputs video files into target formats."),
        bot_04=Bot("Scrubber", "Generates fast, low-res preview frames for the timeline."),
        worker_port=None,
        worker_path="src/studio/",
    ),
    ...
    "Fabulousa": LocationEntity(
        ...
        bot_01=Bot("Pixel-Pusher", "Adjusts components to the pixel for visual alignment."),
        bot_02=Bot("Hex-Code", "Verifies color accuracy and dynamic CSS themes."),
        bot_03=Bot("Font-Fetcher", "Loads and handles web typography assets/fallbacks."),
    ...
    "Imaginarium": LocationEntity(
        ...
        agent_alpha=Agent("The Alchemist", "Translates product plans into multi-app design sequences."),
        agent_beta=Agent("The Architect", "Bridges visual layouts with structural code bindings."),
        bot_01=Bot("Mixer", "Groups images, media, and 3D files into unified folders."),
        bot_02=Bot("Blender", "Resolves layer conflicts when combining 2D, 3D, and UI."),
        bot_03=Bot("Welder", "Links user input triggers in the UI directly to backend functions."),
        bot_04=Bot("Polisher", "Runs final visual sweeps on lighting, styling, and alignment."),
        worker_port=None,
        worker_path="src/studio/",
    ),
    ...
    "The Digital Grid": LocationEntity(
        ...
        agent_beta=Agent("Event-Broker", "Monitors webhooks, sending signals for automated triggers."),
        bot_01=Bot("Trigger", "Detects events and instantly launches the automation sequence."),
        bot_02=Bot("Action", "Runs data changes, logs updates, or makes API calls."),
        bot_03=Bot("Condition", "Evaluates true/false logic, directing workflow paths."),
        bot_04=Bot("Loop", "Runs batch processing tasks over lists to prevent freezes."),
        worker_port=8010,
    ...
    "The Lab": LocationEntity(
        ...
        agent_alpha=Agent("The Hounds", "Searches sandbox code for syntax errors and memory leaks."),
        agent_beta=Agent("Syntax-Sage", "Reads active scripts, suggesting code optimization patterns."),
    ...
    "The Workshop": LocationEntity(
        ...
        agent_alpha=Agent("Branch-Manager", "Tracks active code branches, conflicts, and pull requests."),
        agent_beta=Agent("Merge-Master", "Safely merges code branches, guiding users through conflicts."),
    ...
    "The Chaos Party": LocationEntity(
        ...
        agent_alpha=Agent("The March Hare", "Sends rapid mock inputs and payloads to stress-test systems."),
        agent_beta=Agent("The Dormouse", "Sits silently in tests, measuring memory leaks/performance dips."),
        bot_01=Bot("Teapot", "Spams server endpoints with massive requests to test load limits."),
        bot_02=Bot("Pocket-Watch", "Tracks API response times during load spikes for latency alerts."),
        bot_03=Bot("Sugar-Cube", "Generates messy mockup databases to test bad dataset handling."),
        bot_04=Bot("Jam-Tart", "Shuts down minor random services mid-test to check recovery."),
        worker_port=None,
        worker_path="tests/",
    ),
    ...
    "The Artifactory": LocationEntity(
        ...
        agent_alpha=Agent("The Librarian", "Catalogs compiled code assets, container images, and packages."),
        agent_beta=Agent("The Archivist", "Packages ecosystem snapshots into safe, deployable restore files."),
        bot_01=Bot("Packer", "Compiles software libraries and environments into container images."),
        bot_02=Bot("Unpacker", "Extracts container assets, mounting them in active servers."),
        bot_03=Bot("Checksum", "Generates secure hashes to verify downloaded files are unmodified."),
        bot_04=Bot("Versioner", "Manages software version tags and deprecation warnings."),
        worker_port=None,
    ...
    "API Marketplace": LocationEntity(
        ...
        agent_beta=Agent("The Diplomat", "Handles external handshakes, authentications, and secure keys."),
    ...
    "Royal Bank of Arcadia": LocationEntity(
        ...
        agent_alpha=Agent("The Treasurer", "Monitors resource usage, scaling idle services to approach zero-cost."),
        agent_beta=Agent("The Actuary", "Evaluates system runtime efficiency, mapping ROI metrics."),
        bot_01=Bot("Ledger", "Logs system financial variables, compute costs, and usage logs."),
        bot_02=Bot("Coin", "Manages system credits and tracks processing priority tokens."),
        bot_03=Bot("Ticker", "Tracks cloud rates to buy server space during off-peak hours."),
        bot_04=Bot("Receipt", "Generates transaction recaps, usage invoices, and expense charts."),
        worker_port=8013,
    ...
    "Arcadian Exchange": LocationEntity(
        ...
        agent_alpha=Agent("The Speculator", "Assesses server cost trends to buy bulk compute resources."),
        agent_beta=Agent("The Trader", "Automates bidding on open compute marketplaces for affordability."),
        bot_01=Bot("Bidder", "Submits buy requests on real-time server auctions for processes."),
        bot_02=Bot("Asker", "Sets pricing rules for when external platforms buy Arcadian power."),
        bot_03=Bot("Miner", "Utilizes idle GPU capacity to run calculations or generate assets."),
        bot_04=Bot("Harvester", "Identifies and frees up neglected storage blocks across servers."),
        worker_port=8012,
    ...
    "The Observatory": LocationEntity(
        ...
        agent_alpha=Agent("The Watcher", "Scans monitoring logs in real-time for unusual anomalies/spikes."),
        agent_beta=Agent("The Scribe", "Compresses long log files into searchable summary journals."),
        bot_01=Bot("Log-Alpha", "Captures UI interactions, button clicks, and front-end errors."),
        bot_02=Bot("Log-Beta", "Gathers background server signals, database calls, and backend tasks."),
        bot_03=Bot("Tracer", "Tracks data paths across multiple servers to isolate bottlenecks."),
        bot_04=Bot("Timestamp", "Applies high-precision UTC marks to every event for accuracy."),
        worker_port=8007,
    ...
    "The Library": LocationEntity(
        ...
        agent_alpha=Agent("The Curator", "Identifies duplicated wiki pages and flags outdated articles."),
        agent_beta=Agent("The Indexer", "Adds searchable tags and conceptual links to wiki pages."),
        bot_01=Bot("Page", "Processes text inputs, rendering clean wiki documents in markdown."),
        bot_02=Bot("Bookmark", "Logs user favourite files and recent reading history."),
        bot_03=Bot("Spine", "Ensures all internal page links work, keeping documents connected."),
        bot_04=Bot("Dust-Jacket", "Generates quick summaries of newly updated documentation."),
        worker_port=8017,
    ...
    "The Academy": LocationEntity(
        ...
        agent_alpha=Agent("The Tutor", "Modifies materials and guides to match user progress/skill."),
        agent_beta=Agent("The Proctor", "Evaluates practice coding exercises and logs test scores."),
        bot_01=Bot("Chalk", "Projects visual charts and interactive terminal sandboxes in the UI."),
        bot_02=Bot("Board", "Manages course paths, student lists, and syllabus structures."),
        bot_03=Bot("Eraser", "Resets coding sandboxes, removing trial code for the next lesson."),
        bot_04=Bot("Bell", "Sends notifications for class dates, live sessions, or deadlines."),
        worker_port=None,
    ...
    "DocUtari": LocationEntity(
        ...
        agent_alpha=Agent("The Filer", "Places files in structured folders, ensuring quick retrieval."),
        agent_beta=Agent("The Tagger", "Scans text documents to add descriptive, searchable tags."),
        bot_01=Bot("Scanner", "Performs OCR on image uploads to extract readable text."),
        bot_02=Bot("Stapler", "Bundles related drafts, spreadsheets, and pictures into packets."),
        bot_03=Bot("Folder", "Handles privacy and permission rules on individual files/directories."),
        bot_04=Bot("Shredder", "Overwrites deleted files with random characters for secure destruction."),
        worker_port=8014,
    ...
    "The Basement": LocationEntity(
        ...
        agent_alpha=Agent("The Undertaker", "Finds stale databases, archiving them in cold storage."),
        agent_beta=Agent("The Miner", "Searches deep archive catalogs, pulling up requested documents."),
        bot_01=Bot("Compressor", "Runs file compression routines to keep cold storage costs low."),
        bot_02=Bot("Extractor", "Unpacks old archives without data corruption."),
        bot_03=Bot("Dust-Bunny", "Identifies and deletes empty files and corrupted folders."),
        bot_04=Bot("Mothball", "Encrypts and locks retired legacy versions of platform software."),
        worker_port=None,
    ...
    "The Spark": LocationEntity(
        ...
        agent_alpha=Agent("The Matchmaker", "Matches multi-node requests with the correct skilled AI/Agent."),
        agent_beta=Agent("The Router", "Re-routes service queries if a designated AI has high-load delays."),
        bot_01=Bot("Spark-1", "Emits active status signals to keep track of ready Agents."),
        bot_02=Bot("Spark-2", "Collects processing load updates to support routing decisions."),
        bot_03=Bot("Linker", "Establishes secure channels between seeking and assisting nodes."),
        bot_04=Bot("Pinger", "Evaluates responsiveness of specific skills, flagging missing capabilities."),
        worker_port=None,
        worker_path="src/mcp/",
    ),
    ...
    "Infinity": LocationEntity(
        ...
        agent_alpha=Agent("The Gatekeeper", "Checks incoming user logins, issuing secure, temporary keys."),
        agent_beta=Agent("The Bouncer", "Monitors login origins and activities, blocking suspicious IPs."),
        bot_01=Bot("Token-Minter", "Generates secure, time-limited tokens for node-crossing users."),
        bot_02=Bot("Auth-Check", "Verifies active user permissions before unlocking private features."),
        bot_03=Bot("Key-Gen", "Handles local encryption keys to authorize offline applications."),
        bot_04=Bot("Sentry", "Logs security events, highlighting failed login attempts."),
        worker_port=8005,
    ...
    "The Void": LocationEntity(
        ...
        agent_alpha=Agent("Crypt-Keeper", "Coordinates zero-knowledge DB access; splits/protects keys."),
        agent_beta=Agent("The Silencer", "Sanitizes outbound streams so sensitive data avoids general logs."),
        bot_01=Bot("Hash", "Converts passwords and secrets into secure cryptographic strings."),
        bot_02=Bot("Salt", "Adds randomized padding to password strings to prevent dictionary attacks."),
        bot_03=Bot("Cipher", "Runs real-time encryption and decryption on active secure files."),
        bot_04=Bot("Padlock", "Instantly locks sensitive structures if a local breach is suspected."),
        worker_port=8024,
    ...
    "The Lighthouse": LocationEntity(
        ...
        agent_alpha=Agent("The Minter", "Mints unique cryptographic identifier tokens for all new content."),
        agent_beta=Agent("The Stamper", "Attaches verified, tamper-evident digital metadata to packets."),
        bot_01=Bot("Seal", "Locks system-state snapshots, preventing unauthorized modifications."),
        bot_02=Bot("Wax", "Generates temporary, single-use visual watermarks for digital assets."),
        bot_03=Bot("Signet", "Validates credentials, signing certificates for structural operations."),
    ...
    "The Warp Tunnel": LocationEntity(
        ...
        agent_alpha=Agent("The Warden", "Oversees integrity scans for mutated or corrupted system files."),
        agent_beta=Agent("The Inspector", "Compares active database hashes against secure Lighthouse standards."),
        bot_01=Bot("Scanner", "Performs background sweeps on directories, reading cryptographic stamps."),
        bot_02=Bot("Sniffer", "Analyzes transport packets for corrupted signatures/manipulations."),
        bot_03=Bot("Beam", "Isolates threatened memory spaces, cutting off surrounding connections."),
        bot_04=Bot("Portal", "Safely moves compromised file layers directly into the secure Ice Box."),
        worker_port=None,
    ...
    "Cryptex": LocationEntity(
        ...
        agent_alpha=Agent("The Shield", "Configures dynamic firewall rules, blocking network threats live."),
        agent_beta=Agent("The Spear", "Automatically performs pen-testing against internal defenses."),
        bot_01=Bot("Blocker", "Blacklists malicious IP ranges, halting DDoS attacks at the gateway."),
        bot_02=Bot("Tracer", "Traces malicious attacks back to origin networks for reporting."),
        bot_03=Bot("Patcher", "Applies emergency system patches to vulnerable software layers."),
        bot_04=Bot("Honeypot", "Spins up virtual servers with decoy data to distract/evaluate attackers."),
        worker_port=8026,
    ...
    "The Ice Box": LocationEntity(
        ...
        agent_alpha=Agent("The Jailer", "Manages secure quarantine zones, keeping malicious payloads isolated."),
        agent_beta=Agent("The Interrogator", "Triggers/monitors quarantine code execution to document behaviors."),
        bot_01=Bot("Frostbite", "Halts execution threads when sandbox boundaries are breached."),
        bot_02=Bot("Icicle", "Freezes dynamic processes to snapshot active RAM and memory spaces."),
        bot_03=Bot("Glacier", "Packs dangerous binaries into heavily restricted, un-executable archives."),
        bot_04=Bot("Permafrost", "Isolates local offline storage caches until secure networks reconnect."),
        worker_port=None,
    ...
    "Warp Radio": LocationEntity(
        ...
        agent_alpha=Agent("The DJ", "Curates spatial music playlists/soundscapes to match user activities."),
        agent_beta=Agent("The Maestro", "Dynamically balances system alert volumes with external platforms."),
        bot_01=Bot("Play", "Connects/streams music data directly from Spotify, Apple, and Amazon."),
        bot_02=Bot("Pause", "Holds audio states and syncs current track metrics across devices."),
        bot_03=Bot("Skip", "Fetches adjacent track metadata, pre-buffering streams to stop latency."),
        bot_04=Bot("Volume", "Adjusts volume properties, executing smooth fades across node transitions."),
        worker_port=None,
    ...
    "The Dutchy": LocationEntity(
        ...
        agent_alpha=Agent("The Spy", "Gathers sentiment data from public channels to gauge market trends."),
        agent_beta=Agent("The Oracle", "Converts intelligence records into structured development blueprints."),
        bot_01=Bot("Scraper", "Pulls text data from developer channels, social spaces, and trackers."),
        bot_02=Bot("Parser", "Sanitizes and categorizes scraped data, cleaning up format issues."),
        bot_03=Bot("Crawler", "Dispatches web agents to identify relevant API and tech changes."),
        bot_04=Bot("Whisper", "Delivers summarized threat and trend alerts directly to strategic hubs."),
        worker_port=8027,
    ...
    "The Citadel": LocationEntity(
        ...
        agent_alpha=Agent("The General", "Directs high-level development priorities, adjusting assignments."),
        agent_beta=Agent("The Tactician", "Re-allocates team structures to meet immediate design objectives."),
        bot_01=Bot("Map", "Projects system metrics on command dashboards, visualizing node relations."),
        bot_02=Bot("Compass", "Highlights project priorities, guiding developmental focuses."),
        bot_03=Bot("Clock", "Coordinates cross-node releases to ensure aligned rollouts."),
        bot_04=Bot("Radio", "Broadcasts executive platform priorities directly to low-tier Agents."),
        worker_port=None,
        worker_path="deploy/",
    ),
    ...
    "Think Tank": LocationEntity(
        ...
        agent_alpha=Agent("The Professor", "Simulates untested programmatic changes to assess system impacts."),
        agent_beta=Agent("The Visionary", "Suggests structural updates and feature builds based on telemetry."),
        bot_01=Bot("Beaker", "Handles lightweight, isolated experiment runtimes to test novel ideas."),
        bot_02=Bot("Bunsen", "Runs performance limits tests, checking system thresholds."),
        bot_03=Bot("Pipette", "Collects minute execution metrics from experiment test runs."),
        bot_04=Bot("Petri", "Grows mock datasets to support testing operations."),
        worker_port=None,
    ...
    "Turing's Hub": LocationEntity(
        ...
        agent_alpha=Agent("The Sculptor", "Designs and rigs detailed 3D virtual avatars and physical assets."),
        agent_beta=Agent("The Geneticist", "Outlines AI profiles, mapping personality metrics, skills, and tiers."),
        bot_01=Bot("Wireframe", "Builds raw skeleton rigs to support fluid avatar movements."),
        bot_02=Bot("Texture", "Maps high-fidelity styles and graphic materials onto 3D assets."),
        bot_03=Bot("Vocoder", "Synthesizes natural, human-sounding speech patterns for virtual avatars."),
        bot_04=Bot("Optic", "Handles spatial recognition cameras to let avatars look and navigate correctly."),
        worker_port=None,
    ...
    "ChronosSphere / ArcStream": LocationEntity(
        ...
        agent_alpha=Agent("The Timekeeper", "Rearranges task backlogs and priorities to prevent bottlenecks."),
        agent_beta=Agent("The Weaver", "Translates timeline parameters into interactive visual Gantt views."),
        bot_01=Bot("Tick", "Triggers routine cron jobs and automated calendar actions across platforms."),
        bot_02=Bot("Tock", "Evaluates run times, flagging processes that run over temporal parameters."),
        bot_03=Bot("Pendulum", "Manages state changes, supporting task rollbacks during troubleshooting."),
        bot_04=Bot("Sandglass", "Monitors deadlines, safely shutting down operations that exceed time limits."),
        worker_port=8021,
    ...
    "DevOcity": LocationEntity(
        ...
        agent_alpha=Agent("The Foreman", "Coordinates deployment pipelines, checking safety metrics before pushes."),
        agent_beta=Agent("The Dispatcher", "Launches automated server scaling, optimizing system allocations."),
        bot_01=Bot("Crane", "Deploys container setups seamlessly across cloud server hosts."),
        bot_02=Bot("Wrench", "Automatically fixes common connection or database issues during deployment."),
        bot_03=Bot("Gear", "Synchronizes container nodes to keep system speeds and instances consistent."),
        bot_04=Bot("Belt", "Manages continuous compilation pipelines, guiding code from start to finish."),
        worker_port=8029,
    ...
    "Tranquility": LocationEntity(
        ...
        agent_alpha=Agent("The Guide", "Screens user stress metrics, suggesting wellbeing sub-nodes for relief."),
        agent_beta=Agent("The Healer", "Directs relaxation routines, helping users reset focus after intense sessions."),
        bot_01=Bot("Breath", "Plays pacing animations to guide calm, measured breathing patterns."),
        bot_02=Bot("Pulse", "Evaluates user inputs to suggest targeted relaxation periods throughout the day."),
        bot_03=Bot("Calm", "Decreases interface noise, dimming displays and silencing non-critical alerts."),
        bot_04=Bot("Aura", "Adjusts ambient color backlighting across platforms to support user relaxation."),
        worker_port=None,
    ...
    "I-Mind": LocationEntity(
        ...
        agent_alpha=Agent("The Counselor", "Leads reflection sessions, parsing input to measure emotional fatigue."),
        agent_beta=Agent("The Listener", "Passively monitors workspace text patterns for high stress or frustration."),
        bot_01=Bot("Journal", "Encrypts, parses, and securely logs thoughts to track personal emotional patterns."),
        bot_02=Bot("Mood", "Translates sentiment patterns into precise emotional sensitivity metrics on the UI."),
        bot_03=Bot("Reflect", "Retrieves past successful milestones to encourage the user during high-strain events."),
        bot_04=Bot("Soothe", "Triggers local cognitive decompression, offering prompts when distress peaks."),
        worker_port=None,
    ...
    "tAimra": LocationEntity(
        ...
        agent_alpha=Agent("The Shadow", "Mirrors daily habits to anticipate system and scheduling preferences."),
        agent_beta=Agent("The Scheduler", "Adjusts calendar priorities proactively to carve out required rest breaks."),
        bot_01=Bot("Sync", "Pulls data securely from health platforms, applying strict HIPAA encryption."),
        bot_02=Bot("Fetch", "Parses upcoming tasks to flag heavy scheduling days early for the user."),
        bot_03=Bot("Nudge", "Sends gentle notifications suggesting stretches, hydration, or posture breaks."),
        bot_04=Bot("Alert", "Warns users of upcoming tasks, giving them buffer time to finish current work."),
        worker_port=None,
    ...
    "VRAR3D": LocationEntity(
        ...
        agent_alpha=Agent("World-Builder", "Renders calming, expansive three-dimensional therapeutic environments."),
        agent_beta=Agent("The Guide", "Leads users through structured spatial tasks within virtual relaxation areas."),
        bot_01=Bot("Render", "Manages display performance, keeping spatial environments smooth and fluid."),
        bot_02=Bot("Track", "Translates head and hand actions into virtual movement inside scenes."),
        bot_03=Bot("Haptic", "Controls controller rumble patterns to match virtual therapeutic activities."),
    ...
    "Resonate": LocationEntity(
        ...
        agent_alpha=Agent("The Tuner", "Translates emotional telemetry into micro-acoustic shifts matching baselines."),
        agent_beta=Agent("The Balancer", "Screens system audio spikes, softening visual/auditory elements for comfort."),
        bot_01=Bot("Frequency", "Generates custom sound waves (pink/white/brown) to isolate sensory distractions."),
        bot_02=Bot("Wave", "Modulates therapeutic binaural beats to transition brainwaves to deep relaxation."),
        bot_03=Bot("Pitch", "Regulates overall application tones, avoiding sharp frequencies that trigger anxiety."),
        bot_04=Bot("Harmonic", "Smoothly blends external audio playlists with active calming sounds securely."),
        worker_port=None,
