...
PLATFORM_ENTITIES: Dict[str, LocationEntity] = {
    ...
    "Imaginarium": LocationEntity(
        ...
        bot_03=Bot("Welder-Bot", "Links user input triggers in the UI directly to backend functions."),
    ...
    "The Chaos Party": LocationEntity(
        ...
        bot_01=Bot("Teapot-Bot", "Spams server endpoints with massive requests to test load limits."),
        bot_02=Bot("Pocket-Watch-Bot", "Tracks API response times during load spikes for latency alerts."),
        bot_03=Bot("Sugar-Cube-Bot", "Generates messy mockup databases to test bad dataset handling."),
    ...
    "The Artifactory": LocationEntity(
        ...
        bot_01=Bot("Packer-Bot", "Compiles software libraries and environments into container images."),
        bot_02=Bot("Unpacker-Bot", "Extracts container assets, mounting them in active servers."),
        bot_03=Bot("Checksum-Bot", "Generates secure hashes to verify downloaded files are unmodified."),
    ...
    "Royal Bank of Arcadia": LocationEntity(
        ...
        bot_04=Bot("Receipt-Bot", "Generates transaction recaps, usage invoices, and expense charts."),
        worker_port=8013,
    ...
    "Arcadian Exchange": LocationEntity(
        ...
        bot_01=Bot("Bidder-Bot", "Submits buy requests on real-time server auctions for processes."),
        bot_02=Bot("Asker-Bot", "Sets pricing rules for when external platforms buy Arcadian power."),
        bot_03=Bot("Miner-Bot", "Utilizes idle GPU capacity to run calculations or generate assets."),
        bot_04=Bot("Harvester-Bot", "Identifies and frees up neglected storage blocks across servers."),
        worker_port=8012,
    ...
    "The Observatory": LocationEntity(
        ...
        bot_01=Bot("Log-Alpha-Bot", "Captures UI interactions, button clicks, and front-end errors."),
        bot_02=Bot("Log-Beta-Bot", "Gathers background server signals, database calls, and backend tasks."),
        bot_03=Bot("Tracer-Bot", "Tracks data paths across multiple servers to isolate bottlenecks."),
        bot_04=Bot("Timestamp-Bot", "Applies high-precision UTC marks to every event for accuracy."),
        worker_port=8007,
    ...
    "The Library": LocationEntity(
        ...
        bot_01=Bot("Page-Bot", "Processes text inputs, rendering clean wiki documents in markdown."),
        bot_02=Bot("Bookmark-Bot", "Logs user favourite files and recent reading history."),
        bot_03=Bot("Spine-Bot", "Ensures all internal page links work, keeping documents connected."),
    ...
    "The Academy": LocationEntity(
        ...
        bot_01=Bot("Chalk-Bot", "Projects visual charts and interactive terminal sandboxes in the UI."),
        bot_02=Bot("Board-Bot", "Manages course paths, student lists, and syllabus structures."),
        bot_03=Bot("Eraser-Bot", "Resets coding sandboxes, removing trial code for the next lesson."),
    ...
    "DocUtari": LocationEntity(
        ...
        bot_02=Bot("Stapler-Bot", "Bundles related drafts, spreadsheets, and pictures into packets."),
        bot_03=Bot("Folder-Bot", "Handles privacy and permission rules on individual files/directories."),
        bot_04=Bot("Shredder-Bot", "Overwrites deleted files with random characters for secure destruction."),
        worker_port=8014,
    ...
    "The Basement": LocationEntity(
        ...
        bot_01=Bot("Compressor-Bot", "Runs file compression routines to keep cold storage costs low."),
        ...
        bot_04=Bot("Mothball-Bot", "Encrypts and locks retired legacy versions of platform software."),
        worker_port=None,
    ...
    "The Spark": LocationEntity(
        ...
        bot_03=Bot("Linker-Bot", "Establishes secure channels between seeking and assisting nodes."),
        bot_04=Bot("Pinger-Bot", "Evaluates responsiveness of specific skills, flagging missing capabilities."),
        worker_port=None,
        worker_path="src/mcp/",
    ),
    ...
    "Infinity": LocationEntity(
        ...
        bot_01=Bot("Token-Minter-Bot", "Generates secure, time-limited tokens for node-crossing users."),
        bot_02=Bot("Auth-Check-Bot", "Verifies active user permissions before unlocking private features."),
        bot_03=Bot("Key-Gen-Bot", "Handles local encryption keys to authorize offline applications."),
    ...
    "The Void": LocationEntity(
        ...
        bot_02=Bot("Salt-Bot", "Adds randomized padding to password strings to prevent dictionary attacks."),
        bot_03=Bot("Cipher-Bot", "Runs real-time encryption and decryption on active secure files."),
        bot_04=Bot("Padlock-Bot", "Instantly locks sensitive structures if a local breach is suspected."),
        worker_port=8024,
    ...
    "The Lighthouse": LocationEntity(
        ...
        bot_01=Bot("Seal-Bot", "Locks system-state snapshots, preventing unauthorized modifications."),
        bot_02=Bot("Wax-Bot", "Generates temporary, single-use visual watermarks for digital assets."),
        bot_03=Bot("Signet-Bot", "Validates credentials, signing certificates for structural operations."),
    ...
    "The Warp Tunnel": LocationEntity(
        ...
        bot_02=Bot("Sniffer-Bot", "Analyzes transport packets for corrupted signatures/manipulations."),
        bot_03=Bot("Beam-Bot", "Isolates threatened memory spaces, cutting off surrounding connections."),
        bot_04=Bot("Portal-Bot", "Safely moves compromised file layers directly into the secure Ice Box."),
        worker_port=None,
    ...
    "Cryptex": LocationEntity(
        ...
        bot_01=Bot("Blocker-Bot", "Blacklists malicious IP ranges, halting DDoS attacks at the gateway."),
        bot_02=Bot("Trace-Bot", "Traces malicious attacks back to origin networks for reporting."),
        bot_03=Bot("Patcher-Bot", "Applies emergency system patches to vulnerable software layers."),
        bot_04=Bot("Honeypot-Bot", "Spins up virtual servers with decoy data to distract/evaluate attackers."),
        worker_port=8026,
    ...
    "The Ice Box": LocationEntity(
        ...
        bot_01=Bot("Frostbite-Bot", "Halts execution threads when sandbox boundaries are breached."),
        bot_02=Bot("Icicle-Bot", "Freezes dynamic processes to snapshot active RAM and memory spaces."),
        bot_03=Bot("Glacier-Bot", "Packs dangerous binaries into heavily restricted, un-executable archives."),
        bot_04=Bot("Permafrost-Bot", "Isolates local offline storage caches until secure networks reconnect."),
        worker_port=None,
    ...
    "Warp Radio": LocationEntity(
        ...
        bot_01=Bot("Play-Bot", "Connects/streams music data directly from Spotify, Apple, and Amazon."),
        bot_02=Bot("Pause-Bot", "Holds audio states and syncs current track metrics across devices."),
        bot_03=Bot("Skip-Bot", "Fetches adjacent track metadata, pre-buffering streams to stop latency."),
        bot_04=Bot("Volume-Bot", "Adjusts volume properties, executing smooth fades across node transitions."),
        worker_port=None,
    ...
    "The Dutchy": LocationEntity(
        ...
        bot_01=Bot("Scraper-Bot", "Pulls text data from developer channels, social spaces, and trackers."),
        bot_02=Bot("Parser-Bot", "Sanitizes and categorizes scraped data, cleaning up format issues."),
        bot_03=Bot("Crawler-Bot", "Dispatches web agents to identify relevant API and tech changes."),
        bot_04=Bot("Whisper-Bot", "Delivers summarized threat and trend alerts directly to strategic hubs."),
        worker_port=8027,
    ...
    "The Citadel": LocationEntity(
        ...
        bot_01=Bot("Map-Bot", "Projects system metrics on command dashboards, visualizing node relations."),
        ...
        bot_04=Bot("Radio-Bot", "Broadcasts executive platform priorities directly to low-tier Agents."),
        worker_port=None,
        worker_path="deploy/",
    ),
    ...
    "Think Tank": LocationEntity(
        ...
        bot_01=Bot("Beaker-Bot", "Handles lightweight, isolated experiment runtimes to test novel ideas."),
    ...
    "Turing's Hub": LocationEntity(
        ...
        bot_02=Bot("Texture-Bot", "Maps high-fidelity styles and graphic materials onto 3D assets."),
        bot_03=Bot("Vocoder-Bot", "Synthesizes natural, human-sounding speech patterns for virtual avatars."),
        bot_04=Bot("Optic-Bot", "Handles spatial recognition cameras to let avatars look and navigate correctly."),
        worker_port=None,
    ...
    "ChronosSphere / ArcStream": LocationEntity(
        ...
        bot_01=Bot("Tick-Bot", "Triggers routine cron jobs and automated calendar actions across platforms."),
        bot_02=Bot("Tock-Bot", "Evaluates run times, flagging processes that run over temporal parameters."),
        bot_03=Bot("Pendulum-Bot", "Manages state changes, supporting task rollbacks during troubleshooting."),
        bot_04=Bot("Sandglass-Bot", "Monitors deadlines, safely shutting down operations that exceed time limits."),
        worker_port=8021,
    ...
    "DevOcity": LocationEntity(
        ...
        bot_02=Bot("Wrench-Bot", "Automatically fixes common connection or database issues during deployment."),
        bot_03=Bot("Gear-Bot", "Synchronizes container nodes to keep system speeds and instances consistent."),
        bot_04=Bot("Belt-Bot", "Manages continuous compilation pipelines, guiding code from start to finish."),
        worker_port=8029,
    ...
    "Tranquility": LocationEntity(
        ...
        bot_01=Bot("Breath-Bot", "Plays pacing animations to guide calm, measured breathing patterns."),
        bot_02=Bot("Pulse-Bot", "Evaluates user inputs to suggest targeted relaxation periods throughout the day."),
        bot_03=Bot("Calm-Bot", "Decreases interface noise, dimming displays and silencing non-critical alerts."),
        bot_04=Bot("Aura-Bot", "Adjusts ambient color backlighting across platforms to support user relaxation."),
        worker_port=None,
    ...
    "I-Mind": LocationEntity(
        ...
        bot_01=Bot("Journal-Bot", "Encrypts, parses, and securely logs thoughts to track personal emotional patterns."),
        bot_02=Bot("Mood-Bot", "Translates sentiment patterns into precise emotional sensitivity metrics on the UI."),
        bot_03=Bot("Reflect-Bot", "Retrieves past successful milestones to encourage the user during high-strain events."),
        bot_04=Bot("Soothe-Bot", "Triggers local cognitive decompression, offering prompts when distress peaks."),
        worker_port=None,
    ...
    "tAimra": LocationEntity(
        ...
        bot_01=Bot("Sync-Bot", "Pulls data securely from health platforms, applying strict HIPAA encryption."),
        bot_02=Bot("Fetch-Bot", "Parses upcoming tasks to flag heavy scheduling days early for the user."),
        bot_03=Bot("Nudge-Bot", "Sends gentle notifications suggesting stretches, hydration, or posture breaks."),
        bot_04=Bot("Alert-Bot", "Warns users of upcoming tasks, giving them buffer time to finish current work."),
        worker_port=None,
    ...
    "VRAR3D": LocationEntity(
        ...
        bot_01=Bot("Render-Bot", "Manages display performance, keeping spatial environments smooth and fluid."),
        bot_02=Bot("Track-Bot", "Translates head and hand actions into virtual movement inside scenes."),
        bot_03=Bot("Haptic-Bot", "Controls controller rumble patterns to match virtual therapeutic activities."),
    ...
    "Resonate": LocationEntity(
        ...
        bot_01=Bot("Frequency-Bot", "Generates custom sound waves (pink/white/brown) to isolate sensory distractions."),
        bot_02=Bot("Wave-Bot", "Modulates therapeutic binaural beats to transition brainwaves to deep relaxation."),
        bot_03=Bot("Pitch-Bot", "Regulates overall application tones, avoiding sharp frequencies that trigger anxiety."),
        bot_04=Bot("Harmonic-Bot", "Smoothly blends external audio playlists with active calming sounds securely."),
        worker_port=None,
...
LOCATION_ABBREVS: Dict[str, str] = {
    # Architectural
    "The Nexus": "NXS", "The HIVE": "HVE", "Arcadia": "ARC", "Luminous": "LUM",
    "The Town Hall": "TWH",
    # Creativity
    "The Studio": "STD", "Sashas Photo Studio": "SPS", "TranceFlow": "TFL",
    "TateKing": "TKG", "Fabulousa": "FAB", "Imaginarium": "IMG",
    # Development (Code)
    "The Digital Grid": "DGR", "The Lab": "LAB", "The Workshop": "WRK",
    "The Chaos Party": "TCP",
    # Commercial / Financial
    "The Artifactory": "ART", "API Marketplace": "APM",
    "Royal Bank of Arcadia": "RBA", "Arcadian Exchange": "AEX",
    "Warp Radio": "WRA",
    # Knowledge
    "The Observatory": "OBS", "The Library": "LIB", "The Academy": "ACA",
    "DocUtari": "DOC", "The Basement": "BSM", "The Spark": "SPK",
    # Security
    "Infinity": "INF", "The Void": "VOI", "The Lighthouse": "LTH",
    "The Warp Tunnel": "WTP", "Cryptex": "CRX", "The Ice Box": "ICB",
    # DevOps
    "The Dutchy": "DUT", "The Citadel": "CTL", "Think Tank": "TNK",
    "Turing's Hub": "THB", "ChronosSphere / ArcStream": "CHR", "DevOcity": "DEV",
    # Wellbeing
    "Tranquility": "TRQ", "I-Mind": "IMD", "tAimra": "TMR",
    "VRAR3D": "VR3", "Resonate": "RES",
}

PILLAR_ABBREVS: Dict[str, str] = {
    "Architectural": "ARCH", "Commercial / Financial": "COMM",
    "Creativity": "CREA", "Development (Code)": "DEVL",
    "Knowledge": "KNWL", "Security": "SECU",
    "DevOps": "DVOP", "Wellbeing": "WELL",
}

PRIME_ABBREVS: Dict[str, str] = {
    "Cornelius MacIntyre": "COR", "Dorris Fontaine": "DOR",
    "The Guardian": "GRD", "The Doctor (Nikolai O'denhim)": "DOC",
    "Voxx": "VOX", "Norman Hawkins": "NOR",
    "Savania": "SAV", "Trancendos": "TRN",
}
...
def get_all_ids() -> List[Dict]:
    ...
    for loc_name, entity in PLATFORM_ENTITIES.items():
        ...
        result.append({
            "id": entity.aid, "tier": 3, "name": entity.lead_ai,
            "location": loc_name,
        })
        result.append({
            "id": entity.agent_alpha.sid, "tier": 4, "name": entity.agent_alpha.code_name,
            "location": loc_name, "role": "Alpha",
        })
        result.append({
            "id": entity.agent_beta.sid, "tier": 4, "name": entity.agent_beta.code_name,
            "location": loc_name, "role": "Beta",
        })
        for bot_field, slot in [("bot_01", "01"), ("bot_02", "02"), ("bot_03", "03"), ("bot_04", "04")]:
            bot = getattr(entity, bot_field)
            result.append({
                "id": bot.nid, "tier": 5, "name": bot.code_name,
                "location": loc_name, "slot": slot,
            })
    return result
