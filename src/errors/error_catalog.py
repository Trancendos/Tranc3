...
CATALOG: Dict[ErrorCode, ErrorDefinition] = {
    ...
    ErrorCode.AUTH_TOKEN_MISSING: ErrorDefinition(
        code=ErrorCode.AUTH_TOKEN_MISSING, http_status=401,
        title="Token Missing",
    ...
    ErrorCode.AUTH_USER_NOT_FOUND: ErrorDefinition(
        code=ErrorCode.AUTH_USER_NOT_FOUND, http_status=404,
    ...
    ErrorCode.AUTH_WRONG_PASSWORD: ErrorDefinition(
        code=ErrorCode.AUTH_WRONG_PASSWORD, http_status=401,
    ...
    ErrorCode.AUTH_ACCOUNT_DISABLED: ErrorDefinition(
        code=ErrorCode.AUTH_ACCOUNT_DISABLED, http_status=403,
    ...
    ErrorCode.RATE_TIER_INSUFFICIENT: ErrorDefinition(
        code=ErrorCode.RATE_TIER_INSUFFICIENT, http_status=403,
    ...
    ErrorCode.MODEL_INFERENCE_FAILED: ErrorDefinition(
        code=ErrorCode.MODEL_INFERENCE_FAILED, http_status=500,
    ...
    ErrorCode.MODEL_INPUT_TOO_LONG: ErrorDefinition(
        code=ErrorCode.MODEL_INPUT_TOO_LONG, http_status=400,
    ...
    ErrorCode.MODEL_TOKENIZER_FAILED: ErrorDefinition(
        code=ErrorCode.MODEL_TOKENIZER_FAILED, http_status=500,
    ...
    ErrorCode.DB_WRITE_FAILED: ErrorDefinition(
        code=ErrorCode.DB_WRITE_FAILED, http_status=503,
    ...
    ErrorCode.DB_READ_FAILED: ErrorDefinition(
        code=ErrorCode.DB_READ_FAILED, http_status=503,
    ...
    ErrorCode.QUANT_BACKEND_FAILED: ErrorDefinition(
        code=ErrorCode.QUANT_BACKEND_FAILED, http_status=503,
    ...
    ErrorCode.QUANT_CIRCUIT_ERROR: ErrorDefinition(
        code=ErrorCode.QUANT_CIRCUIT_ERROR, http_status=500,
    ...
    ErrorCode.CONS_PHI_CALC_FAILED: ErrorDefinition(
        code=ErrorCode.CONS_PHI_CALC_FAILED, http_status=500,
    ...
    ErrorCode.CONS_ENGINE_UNAVAILABLE: ErrorDefinition(
        code=ErrorCode.CONS_ENGINE_UNAVAILABLE, http_status=503,
    ...
    ErrorCode.EVOL_NO_FEEDBACK: ErrorDefinition(
        code=ErrorCode.EVOL_NO_FEEDBACK, http_status=400,
    ...
    ErrorCode.EVOL_GENOME_CORRUPT: ErrorDefinition(
        code=ErrorCode.EVOL_GENOME_CORRUPT, http_status=500,
    ...
    ErrorCode.SWARM_NO_NODES: ErrorDefinition(
        code=ErrorCode.SWARM_NO_NODES, http_status=503,
    ...
    ErrorCode.SWARM_CONSENSUS_FAILED: ErrorDefinition(
        code=ErrorCode.SWARM_CONSENSUS_FAILED, http_status=503,
    ...
    ErrorCode.HOLO_ENCODE_FAILED: ErrorDefinition(
        code=ErrorCode.HOLO_ENCODE_FAILED, http_status=500,
    ...
    ErrorCode.HOLO_RECALL_FAILED: ErrorDefinition(
        code=ErrorCode.HOLO_RECALL_FAILED, http_status=500,
    ...
    ErrorCode.SEC_CORS_VIOLATION: ErrorDefinition(
        code=ErrorCode.SEC_CORS_VIOLATION, http_status=403,
    ...
    ErrorCode.SEC_IP_BLOCKED: ErrorDefinition(
        code=ErrorCode.SEC_IP_BLOCKED, http_status=403,
    ...
    ErrorCode.COMP_VIOLATION: ErrorDefinition(
        code=ErrorCode.COMP_VIOLATION, http_status=403,
    ...
    ErrorCode.COMP_GDPR_REQUIRED: ErrorDefinition(
        code=ErrorCode.COMP_GDPR_REQUIRED, http_status=403,
    ...
    ErrorCode.SYS_STARTUP_FAILED: ErrorDefinition(
        code=ErrorCode.SYS_STARTUP_FAILED, http_status=503,
