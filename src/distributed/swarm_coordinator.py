...
class SwarmCoordinator:
    ...
    async def swarm_reasoning(self, problem: Dict[str, Any], user_id: Optional[str] = None) -> Optional[Dict[str, Any]]:
        """
    ...
    async def update_swarm_nodes(self, new_nodes: List[str]):
        ...
        self.swarm_nodes = [
            node for node, health in zip(new_nodes, health_results)
