...
PHASE4_TOOLS = [
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "input_schema": {"type": "array", "items": {"type": "string"}, "description": "Input field names."},
                "output_schema": {"type": "array", "items": {"type": "string"}, "description": "Output field names."},
                "tags": {"type": "array", "items": {"type": "string"}, "description": "Descriptive tags."},
                "parameters": {"type": "object", "description": "Base parameters to adapt."},
            },
    ...
    },
    {
        ...
        "input_schema": {
            "type": "object",
            "properties": {
                "observations": {"type": "object", "description": "Current observed evidence."},
                "interventions": {"type": "object", "description": "Variables to forcibly set."},
                "target_variables": {"type": "array", "items": {"type": "string"},
                                     "description": "Variables to evaluate post-intervention."},
            },
        ...
        "input_schema": {
            ...
            "properties": {
                "history": {"type": "array", "items": {"type": "string"},
                            "description": "Recent messages or event descriptions."},
                "context": {"type": "object", "description": "Additional contextual metadata."},
