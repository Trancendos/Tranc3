"""
Dimensional.security_automation.watchdog — Real-time file watcher with proactive security scanning.
...
Usage:
    from Dimensional.security_automation.watchdog import SecurityWatchdog

    watchdog = SecurityWatchdog(
        watch_paths=["src/", "Dimensional/"],
...
from Dimensional.security_automation.adaptive_scanner import AdaptiveScanner, AdaptiveViolation
