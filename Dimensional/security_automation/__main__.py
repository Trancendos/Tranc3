"""
Dimensional.security_automation.__main__ — CLI entry point.
...
Usage:
    ...
    python -m Dimensional.security_automation scan --severity high src/

    # Auto-fix violations (dry run):
    python -m Dimensional.security_automation fix --dry-run src/
    ...
    python -m Dimensional.security_automation gate src/
...
from Dimensional.security_automation.scanner import Category, SecurityScanner, Severity, Violation
