"""
Dimensional.security_automation.scanner — AST-based proactive security scanner.
...
class PathTraversalChecker(RuleChecker):
    ...
    from Dimensional.path_validation BEFORE the filesystem operation.
    """
                    ...
                    if self._is_unvalidated_path(arg, validated_vars, safe_join_vars):
                        violations.append(
                            Violation(
                                ...
                                suggestion="Use validate_path(user_path, base_dir) from Dimensional.path_validation",
                                fixable=False,
                            )
                        )
                    ...
                    if self._is_unvalidated_path(obj, validated_vars, safe_join_vars):
                        violations.append(
                            Violation(
                                ...
                                suggestion="Use validate_path(path, base_dir) from Dimensional.path_validation before this call",
                                fixable=False,
                            )
                        )
                            ...
                            if self._is_unvalidated_path(dst_arg, validated_vars, safe_join_vars):
                                violations.append(
                                    Violation(
                                        ...
                                        suggestion="Use validate_path(dst, base_dir) from Dimensional.path_validation before this call",
                                        fixable=False,
                                    )
                                )
                            ...
                            if self._is_unvalidated_path(arg, validated_vars, safe_join_vars):
                                violations.append(
                                    Violation(
                                        ...
                                        suggestion="Use validate_path(path, base_dir) from Dimensional.path_validation",
                                        fixable=False,
                                    )
                                )
