# Dimensional/architecture/oci_storage.py — Oracle Cloud Infrastructure Object Storage Provider
...
from Dimensional.architecture.storage_factory import StorageProvider, SystemMode
