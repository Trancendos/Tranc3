...
| Readiness | 9/10 | status ✅ in CLAUDE.md (+3); code path `workers/the-grid/` exists on disk (+2); three or more Python files present (+2); compose service `the-grid` defined (+2) |
