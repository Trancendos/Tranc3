...
**Criticality 4/10 · Readiness 9/10 → Finish first — above-median dependency, above-median readiness**
...
| Readiness | 9/10 | status ✅ in CLAUDE.md (+3); code path `src/studio/` exists on disk (+2); 3 Python files present (+2); compose service `tateking` defined (+2) |
