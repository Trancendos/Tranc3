...
| Readiness | 8/10 | status 🔧 partial/migrating (+1); code path `workers/infinity-ai/` exists on disk (+2); 13 Python files present (+2); compose service `infinity-ai` defined (+2); 2 test file(s) (+1) |
