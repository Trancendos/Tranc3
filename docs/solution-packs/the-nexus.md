...
| Readiness | 6/10 | status 🔧 partial/migrating (+1); code path `workers/infinity-ws/` exists on disk (+2); 2 Python file(s) present (+1); compose service `infinity-ws` defined (+2) |
