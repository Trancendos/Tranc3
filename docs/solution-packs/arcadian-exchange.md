...
| Readiness | 8/10 | status ✅ in CLAUDE.md (+3); code path `workers/orders-service/` exists on disk (+2); 1 Python file(s) present (+1); compose service `orders-service` defined (+2) |
