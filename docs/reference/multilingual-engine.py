...
LANGUAGE_CODES = {
    ...
    'tl':'tagalog','sw':'swahili','am':'amharic','yo':'yoruba',
    'ha':'hausa','ig':'igbo','zu':'zulu','af':'afrikaans',
...
class MultilingualTokenizer:
    ...
    def encode(self, text: str, language: str = 'en',
               return_tensors: bool = True) -> Dict:
    ...
    def _mock_encode(self, text: str) -> Dict:
        ...
        return {'input_ids': ids, 'attention_mask': mask, 'language': 'en', 'token_count': len(text)}
