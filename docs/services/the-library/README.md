...
|---|---|---|---|
| Foundation | Outline (self-hosted, `outline/outline`) | self-hosted / OSS | **code exists, integration unverified** — see correction above |

NOTE: this claim is stale — code already exists in this repo for The Library (see correction
