...
|---|---|---|---|
| Foundation | FFmpeg + custom UI | self-hosted / OSS | **code exists, integration unverified** — see correction above |

NOTE: this claim is stale — code already exists in this repo for TateKing (see correction
