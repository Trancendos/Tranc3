...
|---|---|---|---|
| Foundation | custom (planned `src/warp_radio/`) | self-hosted / OSS | **code exists, integration unverified** — see correction above |

NOTE: this claim is stale — code already exists in this repo for Warp Radio (see correction
