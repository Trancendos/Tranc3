...
|---|---|---|---|
| Foundation | custom (planned `src/taimra/`) | self-hosted / OSS | **code exists, integration unverified** — see correction above |

NOTE: this claim is stale — code already exists in this repo for tAimra (see correction
