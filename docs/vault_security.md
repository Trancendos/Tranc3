...
**Usage:**
```python
from Dimensionals.architecture.vault_security import SecureBytes
...
**Usage:**
```python
from Dimensionals.architecture.vault_security import VaultSecretLoader, SoftHSM2Provider
...
**Usage:**
```python
from Dimensionals.architecture.vault_security import SoftHSM2Provider, HSMKeyType
...
**Usage:**
```python
from Dimensionals.architecture.vault_security import YubiHSM2Provider, HSMKeyType
...
**Usage:**
```python
from Dimensionals.architecture.vault_security import VaultAuditLogger
